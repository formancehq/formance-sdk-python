...
with SDK(
    ...
    res = sdk.webhooks.activate_config(request={
...
with SDK(
    ...
    res = sdk.webhooks.change_config_secret(request={
        "id": "4997257d-dfb6-445b-929c-cbe2ab182818",
...
with SDK(
    ...
    res = sdk.webhooks.deactivate_config(request={
        "id": "4997257d-dfb6-445b-929c-cbe2ab182818",
    })
...
with SDK(
    ...
    res = sdk.webhooks.delete_config(request={
        "id": "4997257d-dfb6-445b-929c-cbe2ab182818",
    })
...
with SDK(
    ...
    res = sdk.webhooks.get_many_configs(request={
...
with SDK(
    ...
    res = sdk.webhooks.insert_config(request={
        "endpoint": "https://example.com",
        "event_types": [
            "TYPE1",
        ],
...
with SDK(
    ...
    res = sdk.webhooks.test_config(request={
        "id": "4997257d-dfb6-445b-929c-cbe2ab182818",
    })
