...
with SDK(
    ...
    res = sdk.auth.create_secret(request={
        "client_id": "<id>",
    })
...
with SDK(
    ...
    res = sdk.auth.delete_client(request={
        "client_id": "<id>",
    })
...
with SDK(
    ...
    res = sdk.auth.delete_secret(request={
        "client_id": "<id>",
        "secret_id": "<id>",
    })
...
with SDK(
    ...
    res = sdk.auth.read_client(request={
        "client_id": "<id>",
    })
...
with SDK(
    ...
    res = sdk.auth.read_user(request={
        "user_id": "<id>",
    })
...
with SDK(
    ...
    res = sdk.auth.update_client(request={
        "client_id": "<id>",
    })
