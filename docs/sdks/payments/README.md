...
with SDK(
    ...
    res = sdk.payments.add_account_to_pool(request={
...
with SDK(
    ...
    res = sdk.payments.connectors_transfer(request={
        "transfer_request": {
            "amount": 100,
            "asset": "USD",
...
with SDK(
    ...
    res = sdk.payments.create_account(request={
        "connector_id": "<id>",
...
with SDK(
    ...
    res = sdk.payments.create_bank_account(request={
        "connector_id": "<id>",
        "country": "GB",
        "name": "My account",
    })
...
with SDK(
    ...
    res = sdk.payments.create_payment(request={
        "amount": 100,
        "asset": "USD",
        "connector_id": "<id>",
...
with SDK(
    ...
    res = sdk.payments.create_pool(request={
        "account_i_ds": [
            "<value>",
            "<value>",
            "<value>",
...
with SDK(
    ...
    res = sdk.payments.create_transfer_initiation(request={
        "amount": 256698,
        "asset": "USD",
...
with SDK(
    ...
    res = sdk.payments.delete_pool(request={
        "pool_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.delete_transfer_initiation(request={
        "transfer_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.forward_bank_account(request={
...
with SDK(
    ...
    res = sdk.payments.get_account_balances(request={
        "account_id": "XXX",
...
with SDK(
    ...
    res = sdk.payments.get_bank_account(request={
        "bank_account_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.get_connector_task(request={
...
with SDK(
    ...
    res = sdk.payments.get_connector_task_v1(request={
        "connector": shared.Connector.BANKING_CIRCLE,
        "connector_id": "XXX",
        "task_id": "task1",
    })
...
with SDK(
    ...
    res = sdk.payments.get_payment(request={
        "payment_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.get_pool(request={
        "pool_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.get_pool_balances(request={
...
with SDK(
    ...
    res = sdk.payments.get_transfer_initiation(request={
        "transfer_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.install_connector(request={
        "connector_config": {
            "api_key": "XXX",
...
with SDK(
    ...
    res = sdk.payments.list_all_connectors()
...
with SDK(
    ...
    res = sdk.payments.list_bank_accounts(request={
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
        "sort": [
            "date:asc",
            "status:desc",
...
with SDK(
    ...
    res = sdk.payments.list_configs_available_connectors()
...
with SDK(
    ...
    res = sdk.payments.list_connector_tasks(request={
...
with SDK(
    ...
    res = sdk.payments.list_connector_tasks_v1(request={
        "connector": shared.Connector.BANKING_CIRCLE,
        "connector_id": "XXX",
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
    })
...
with SDK(
    ...
    res = sdk.payments.list_payments(request={
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
        "sort": [
            "date:asc",
            "status:desc",
...
with SDK(
    ...
    res = sdk.payments.list_pools(request={
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
        "sort": [
            "date:asc",
            "status:desc",
...
with SDK(
    ...
    res = sdk.payments.list_transfer_initiations(request={
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
        "sort": [
            "date:asc",
            "status:desc",
...
with SDK(
    ...
    res = sdk.payments.paymentsget_account(request={
        "account_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.paymentsget_server_info()
...
with SDK(
    ...
    res = sdk.payments.paymentslist_accounts(request={
        "cursor": "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==",
        "sort": [
            "date:asc",
            "status:desc",
...
with SDK(
    ...
    res = sdk.payments.read_connector_config(request={
...
with SDK(
    ...
    res = sdk.payments.read_connector_config_v1(request={
...
with SDK(
    ...
    res = sdk.payments.remove_account_from_pool(request={
        "account_id": "XXX",
        "pool_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.reset_connector(request={
        "connector": shared.Connector.ATLAR,
    })
...
with SDK(
    ...
    res = sdk.payments.reset_connector_v1(request={
        "connector": shared.Connector.GENERIC,
        "connector_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.retry_transfer_initiation(request={
        "transfer_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.reverse_transfer_initiation(request={
...
with SDK(
    ...
    res = sdk.payments.udpate_transfer_initiation_status(request={
...
with SDK(
    ...
    res = sdk.payments.uninstall_connector(request={
        "connector": shared.Connector.MODULR,
    })
...
with SDK(
    ...
    res = sdk.payments.uninstall_connector_v1(request={
        "connector": shared.Connector.GENERIC,
        "connector_id": "XXX",
    })
...
with SDK(
    ...
    res = sdk.payments.update_bank_account_metadata(request={
...
with SDK(
    ...
    res = sdk.payments.update_connector_config_v1(request={
        "connector_config": {
            "api_key": "XXX",
...
with SDK(
    ...
    res = sdk.payments.update_metadata(request={
        "request_body": {
            "key": "<value>",
            "key1": "<value>",
        },
