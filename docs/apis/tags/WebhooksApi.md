...
> ConfigActivatedResponse activate_one_config(id)
...
------------- | ------------- | -------------
[**ConfigActivatedResponse**](../../models/ConfigActivatedResponse.md) |  | 
...
> ConfigActivatedResponse change_one_config_secret(id)
...
> ConfigDeactivatedResponse deactivate_one_config(id)
...
Type | Description  | Notes
------------- | ------------- | -------------
[**ConfigDeactivatedResponse**](../../models/ConfigDeactivatedResponse.md) |  | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**ConfigActivated**]({{complexTypePrefix}}ConfigActivated.md) | [**ConfigActivated**]({{complexTypePrefix}}ConfigActivated.md) | [**ConfigActivated**]({{complexTypePrefix}}ConfigActivated.md) |  | 
...
> ConfigActivatedResponse insert_one_config(config_user)
