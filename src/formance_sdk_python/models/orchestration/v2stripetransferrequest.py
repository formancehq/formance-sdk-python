...
class V2StripeTransferRequestMetadataTypedDict(TypedDict):
...
class V2StripeTransferRequestMetadata(BaseModel):
    r"""A set of key/value pairs that you can attach to a transfer object.
    It can be useful for storing additional information about the transfer in a structured format.
...
class V2StripeTransferRequestTypedDict(TypedDict):
    amount: NotRequired[int]
    asset: NotRequired[str]
    connector_id: NotRequired[str]
    destination: NotRequired[str]
    metadata: NotRequired[V2StripeTransferRequestMetadataTypedDict]
    r"""A set of key/value pairs that you can attach to a transfer object.
    It can be useful for storing additional information about the transfer in a structured format.
...
class V2StripeTransferRequest(BaseModel):
    ...
    metadata: Optional[V2StripeTransferRequestMetadata] = None
    r"""A set of key/value pairs that you can attach to a transfer object.
    It can be useful for storing additional information about the transfer in a structured format.
...
try:
    V2StripeTransferRequest.model_rebuild()
except NameError:
    pass
