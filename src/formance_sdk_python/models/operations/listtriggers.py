...
from formance_sdk_python.models.orchestration import (
    listtriggersresponse as orchestration_listtriggersresponse,
)
...
class ListTriggersResponseTypedDict(TypedDict):
    ...
    list_triggers_response: NotRequired[
        orchestration_listtriggersresponse.ListTriggersResponseTypedDict
    ]
    r"""List of triggers"""
...
class ListTriggersResponse(BaseModel):
    ...
    list_triggers_response: Optional[
        orchestration_listtriggersresponse.ListTriggersResponse
    ] = None
    r"""List of triggers"""
