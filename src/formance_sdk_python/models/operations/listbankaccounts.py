...
from formance_sdk_python.models.payments import (
    bankaccountscursor as payments_bankaccountscursor,
)
...
class ListBankAccountsRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["cursor", "pageSize", "sort"])
...
class ListBankAccountsResponseTypedDict(TypedDict):
    ...
    bank_accounts_cursor: NotRequired[
        payments_bankaccountscursor.BankAccountsCursorTypedDict
    ]
    r"""OK"""
...
class ListBankAccountsResponse(BaseModel):
    ...
    bank_accounts_cursor: Optional[payments_bankaccountscursor.BankAccountsCursor] = (
        None
    )
    r"""OK"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["BankAccountsCursor"])
        serialized = handler(self)
        m = {}
