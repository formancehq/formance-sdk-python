...
class DeleteTransferInitiationRequest(BaseModel):
...
class DeleteTransferInitiationResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteTransferInitiationResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
