...
from formance_sdk_python.models.webhooks import (
    configsresponse as webhooks_configsresponse,
)
...
class GetManyConfigsRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["endpoint", "id"])
...
class GetManyConfigsResponseTypedDict(TypedDict):
    ...
    configs_response: NotRequired[webhooks_configsresponse.ConfigsResponseTypedDict]
    r"""OK"""
...
class GetManyConfigsResponse(BaseModel):
    ...
    configs_response: Optional[webhooks_configsresponse.ConfigsResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ConfigsResponse"])
        serialized = handler(self)
        m = {}
