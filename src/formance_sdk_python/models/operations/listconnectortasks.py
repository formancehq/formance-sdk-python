...
from formance_sdk_python.models.payments import (
    ...
    taskscursor as payments_taskscursor,
)
...
class ListConnectorTasksResponseTypedDict(TypedDict):
    content_type: str
    ...
    tasks_cursor: NotRequired[payments_taskscursor.TasksCursorTypedDict]
    r"""OK"""


class ListConnectorTasksResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    tasks_cursor: Optional[payments_taskscursor.TasksCursor] = None
    r"""OK"""
