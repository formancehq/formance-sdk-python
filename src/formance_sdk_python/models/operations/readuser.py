...
from formance_sdk_python.models.auth import readuserresponse as auth_readuserresponse
...
class ReadUserResponseTypedDict(TypedDict):
    ...
    read_user_response: NotRequired[auth_readuserresponse.ReadUserResponseTypedDict]
    r"""Retrieved user"""
...
class ReadUserResponse(BaseModel):
    ...
    read_user_response: Optional[auth_readuserresponse.ReadUserResponse] = None
    r"""Retrieved user"""
