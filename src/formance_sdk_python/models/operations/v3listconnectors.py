...
from formance_sdk_python.models.payments import (
    v3connectorscursorresponse as payments_v3connectorscursorresponse,
)
...
class V3ListConnectorsResponseTypedDict(TypedDict):
    ...
    v3_connectors_cursor_response: NotRequired[
        payments_v3connectorscursorresponse.V3ConnectorsCursorResponseTypedDict
    ]
    r"""OK"""
...
class V3ListConnectorsResponse(BaseModel):
    ...
    v3_connectors_cursor_response: Optional[
        payments_v3connectorscursorresponse.V3ConnectorsCursorResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["V3ConnectorsCursorResponse"])
        serialized = handler(self)
        m = {}
