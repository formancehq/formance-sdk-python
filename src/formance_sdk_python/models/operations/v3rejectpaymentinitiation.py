...
class V3RejectPaymentInitiationRequest(BaseModel):
...
class V3RejectPaymentInitiationResponseTypedDict(TypedDict):
    content_type: str
...
class V3RejectPaymentInitiationResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
