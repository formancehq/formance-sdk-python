...
from formance_sdk_python.models.orchestration import (
    v2runworkflowresponse as orchestration_v2runworkflowresponse,
)
...
class V2RunWorkflowResponseTypedDict(TypedDict):
    ...
    v2_run_workflow_response: NotRequired[
        orchestration_v2runworkflowresponse.V2RunWorkflowResponseTypedDict
    ]
...
class V2RunWorkflowResponse(BaseModel):
    ...
    v2_run_workflow_response: Optional[
        orchestration_v2runworkflowresponse.V2RunWorkflowResponse
    ] = None
    r"""The workflow instance"""
