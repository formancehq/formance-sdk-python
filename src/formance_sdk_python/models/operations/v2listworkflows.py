...
from formance_sdk_python.models.orchestration import (
    v2listworkflowsresponse as orchestration_v2listworkflowsresponse,
)
...
class V2ListWorkflowsResponseTypedDict(TypedDict):
    ...
    v2_list_workflows_response: NotRequired[
        orchestration_v2listworkflowsresponse.V2ListWorkflowsResponseTypedDict
    ]
    r"""List of workflows"""
...
class V2ListWorkflowsResponse(BaseModel):
    ...
    v2_list_workflows_response: Optional[
        orchestration_v2listworkflowsresponse.V2ListWorkflowsResponse
    ] = None
    r"""List of workflows"""
