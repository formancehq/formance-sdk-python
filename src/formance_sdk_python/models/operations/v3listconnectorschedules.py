...
from formance_sdk_python.models.payments import (
    v3connectorschedulescursorresponse as payments_v3connectorschedulescursorresponse,
)
...
class V3ListConnectorSchedulesResponseTypedDict(TypedDict):
    ...
    v3_connector_schedules_cursor_response: NotRequired[
        payments_v3connectorschedulescursorresponse.V3ConnectorSchedulesCursorResponseTypedDict
    ]
    r"""OK"""
...
class V3ListConnectorSchedulesResponse(BaseModel):
    ...
    v3_connector_schedules_cursor_response: Optional[
        payments_v3connectorschedulescursorresponse.V3ConnectorSchedulesCursorResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["V3ConnectorSchedulesCursorResponse"])
        serialized = handler(self)
        m = {}
