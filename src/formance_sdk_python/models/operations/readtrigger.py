...
from formance_sdk_python.models.orchestration import (
    readtriggerresponse as orchestration_readtriggerresponse,
)
...
class ReadTriggerResponseTypedDict(TypedDict):
    ...
    read_trigger_response: NotRequired[
        orchestration_readtriggerresponse.ReadTriggerResponseTypedDict
    ]
...
class ReadTriggerResponse(BaseModel):
    ...
    read_trigger_response: Optional[
        orchestration_readtriggerresponse.ReadTriggerResponse
    ] = None
    r"""A specific trigger"""
