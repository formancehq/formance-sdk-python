...
from formance_sdk_python.models.payments import (
    paymentscursor as payments_paymentscursor,
)
...
class ListPaymentsResponseTypedDict(TypedDict):
    ...
    payments_cursor: NotRequired[payments_paymentscursor.PaymentsCursorTypedDict]
    r"""OK"""
...
class ListPaymentsResponse(BaseModel):
    ...
    payments_cursor: Optional[payments_paymentscursor.PaymentsCursor] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["PaymentsCursor"])
        serialized = handler(self)
        m = {}
