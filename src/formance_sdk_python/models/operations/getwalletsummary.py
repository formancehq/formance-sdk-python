...
from formance_sdk_python.models.wallets import (
    getwalletsummaryresponse as wallets_getwalletsummaryresponse,
)
...
class GetWalletSummaryResponseTypedDict(TypedDict):
    ...
    get_wallet_summary_response: NotRequired[
        wallets_getwalletsummaryresponse.GetWalletSummaryResponseTypedDict
    ]
    r"""Wallet summary"""
...
class GetWalletSummaryResponse(BaseModel):
    ...
    get_wallet_summary_response: Optional[
        wallets_getwalletsummaryresponse.GetWalletSummaryResponse
    ] = None
    r"""Wallet summary"""
