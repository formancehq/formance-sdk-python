...
from formance_sdk_python.models.payments import (
    reversetransferinitiationrequest as payments_reversetransferinitiationrequest,
)
...
class ReverseTransferInitiationRequest(BaseModel):
    reverse_transfer_initiation_request: Annotated[
        payments_reversetransferinitiationrequest.ReverseTransferInitiationRequest,
