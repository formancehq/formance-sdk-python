...
from formance_sdk_python.models.payments import poolscursor as payments_poolscursor
...
class ListPoolsResponseTypedDict(TypedDict):
    ...
    pools_cursor: NotRequired[payments_poolscursor.PoolsCursorTypedDict]
    r"""OK"""
...
class ListPoolsResponse(BaseModel):
    ...
    pools_cursor: Optional[payments_poolscursor.PoolsCursor] = None
    r"""OK"""
