...
from formance_sdk_python.models.orchestration import (
    v2readtriggerresponse as orchestration_v2readtriggerresponse,
)
...
class V2ReadTriggerResponseTypedDict(TypedDict):
    ...
    v2_read_trigger_response: NotRequired[
        orchestration_v2readtriggerresponse.V2ReadTriggerResponseTypedDict
    ]
...
class V2ReadTriggerResponse(BaseModel):
    ...
    v2_read_trigger_response: Optional[
        orchestration_v2readtriggerresponse.V2ReadTriggerResponse
    ] = None
    r"""A specific trigger"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["V2ReadTriggerResponse"])
