...
from formance_sdk_python.models.wallets import (
    confirmholdrequest as wallets_confirmholdrequest,
)
...
class ConfirmHoldRequestTypedDict(TypedDict):
    ...
    confirm_hold_request: NotRequired[
        wallets_confirmholdrequest.ConfirmHoldRequestTypedDict
    ]
...
class ConfirmHoldRequest(BaseModel):
    ...
    confirm_hold_request: Annotated[
        Optional[wallets_confirmholdrequest.ConfirmHoldRequest],
