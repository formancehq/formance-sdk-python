...
from formance_sdk_python.models.payments import (
    v3accountscursorresponse as payments_v3accountscursorresponse,
)
...
class V3ListAccountsResponseTypedDict(TypedDict):
    ...
    v3_accounts_cursor_response: NotRequired[
        payments_v3accountscursorresponse.V3AccountsCursorResponseTypedDict
    ]
    r"""OK"""


class V3ListAccountsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    v3_accounts_cursor_response: Optional[
        payments_v3accountscursorresponse.V3AccountsCursorResponse
    ] = None
    r"""OK"""
