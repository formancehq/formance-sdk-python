...
class V2SchemasCursorTypedDict(TypedDict):
    data: List[V2SchemaData1TypedDict]
    has_more: bool
    page_size: int
...
class V2SchemasCursor(BaseModel):
    data: List[V2SchemaData1]
