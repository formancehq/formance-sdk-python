...
class V1:
    ...
    def create_client(self, request: Optional[shared.CreateClientRequest] = None) -> operations.CreateClientResponse:
        r"""Create client"""
        hook_ctx = HookContext(operation_id='createClient', oauth2_scopes=['auth:write'], security_source=self.sdk_configuration.security)
    ...
    def create_secret(self, request: operations.CreateSecretRequest) -> operations.CreateSecretResponse:
        ...
        hook_ctx = HookContext(operation_id='createSecret', oauth2_scopes=['auth:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def delete_client(self, request: operations.DeleteClientRequest) -> operations.DeleteClientResponse:
        r"""Delete client"""
        hook_ctx = HookContext(operation_id='deleteClient', oauth2_scopes=['auth:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def delete_secret(self, request: operations.DeleteSecretRequest) -> operations.DeleteSecretResponse:
        ...
        hook_ctx = HookContext(operation_id='deleteSecret', oauth2_scopes=['auth:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_oidc_well_knowns(self) -> operations.GetOIDCWellKnownsResponse:
        ...
        hook_ctx = HookContext(operation_id='getOIDCWellKnowns', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_server_info(self) -> operations.GetServerInfoResponse:
        r"""Get server info"""
        hook_ctx = HookContext(operation_id='getServerInfo', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_clients(self) -> operations.ListClientsResponse:
        r"""List clients"""
        hook_ctx = HookContext(operation_id='listClients', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_users(self) -> operations.ListUsersResponse:
        ...
        List users
        """
        hook_ctx = HookContext(operation_id='listUsers', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def read_client(self, request: operations.ReadClientRequest) -> operations.ReadClientResponse:
        r"""Read client"""
        hook_ctx = HookContext(operation_id='readClient', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def read_user(self, request: operations.ReadUserRequest) -> operations.ReadUserResponse:
        ...
        Read user
        """
        hook_ctx = HookContext(operation_id='readUser', oauth2_scopes=['auth:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def update_client(self, request: operations.UpdateClientRequest) -> operations.UpdateClientResponse:
        r"""Update client"""
        hook_ctx = HookContext(operation_id='updateClient', oauth2_scopes=['auth:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
