...
class V2ExpandedTransaction:
    ...
    post_commit_volumes: Optional[Dict[str, Dict[str, shared_v2volume.V2Volume]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('postCommitVolumes'), 'exclude': lambda f: f is None }})
    pre_commit_volumes: Optional[Dict[str, Dict[str, shared_v2volume.V2Volume]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('preCommitVolumes'), 'exclude': lambda f: f is None }})
