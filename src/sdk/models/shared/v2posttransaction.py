...
class V2PostTransaction:
    ...
    postings: Optional[List[shared_v2posting.V2Posting]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('postings'), 'exclude': lambda f: f is None }})
