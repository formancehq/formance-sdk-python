...
from ..shared import v2workflowinstancehistorystageinput as shared_v2workflowinstancehistorystageinput
from ..shared import v2workflowinstancehistorystageoutput as shared_v2workflowinstancehistorystageoutput
...
class V2WorkflowInstanceHistoryStage:
    ...
    input: shared_v2workflowinstancehistorystageinput.V2WorkflowInstanceHistoryStageInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('input') }})
    ...
    output: Optional[shared_v2workflowinstancehistorystageoutput.V2WorkflowInstanceHistoryStageOutput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('output'), 'exclude': lambda f: f is None }})
