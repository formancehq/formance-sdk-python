...
class DummyPayConfig:
    ...
    file_generation_period: Optional[str] = dataclasses.field(default='10s', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fileGenerationPeriod'), 'exclude': lambda f: f is None }})
