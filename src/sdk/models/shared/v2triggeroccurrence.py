...
class V2TriggerOccurrence:
    ...
    workflow_instance: Optional[V2WorkflowInstance] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('workflowInstance'), 'exclude': lambda f: f is None }})
