...
import dataclasses
from .walletstransaction import WalletsTransaction
...
class GetTransactionsResponseCursor:
    data: List[WalletsTransaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
