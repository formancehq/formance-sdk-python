...
from ..shared import v2stagestatus as shared_v2stagestatus
...
class V2WorkflowInstance:
    ...
    status: Optional[List[shared_v2stagestatus.V2StageStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
