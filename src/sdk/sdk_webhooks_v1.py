...
class SDKWebhooksV1:
    ...
    def activate_config(self, request: operations.ActivateConfigRequest) -> operations.ActivateConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='activateConfig', oauth2_scopes=['webhooks:write'], security_source=self.sdk_configuration.security)
    ...
    def change_config_secret(self, request: operations.ChangeConfigSecretRequest) -> operations.ChangeConfigSecretResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='changeConfigSecret', oauth2_scopes=['webhooks:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def deactivate_config(self, request: operations.DeactivateConfigRequest) -> operations.DeactivateConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deactivateConfig', oauth2_scopes=['webhooks:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def delete_config(self, request: operations.DeleteConfigRequest) -> operations.DeleteConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deleteConfig', oauth2_scopes=['webhooks:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_many_configs(self, request: operations.GetManyConfigsRequest) -> operations.GetManyConfigsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getManyConfigs', oauth2_scopes=['webhooks:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def insert_config(self, request: shared.ConfigUser) -> operations.InsertConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='insertConfig', oauth2_scopes=['webhooks:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def test_config(self, request: operations.TestConfigRequest) -> operations.TestConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='testConfig', oauth2_scopes=['webhooks:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
