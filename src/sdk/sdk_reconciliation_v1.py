...
class SDKReconciliationV1:
    ...
    def create_policy(self, request: shared.PolicyRequest) -> operations.CreatePolicyResponse:
        ...
        Create a policy
        """
        hook_ctx = HookContext(operation_id='createPolicy', oauth2_scopes=['auth:read','reconciliation:write'], security_source=self.sdk_configuration.security)
    ...
    def delete_policy(self, request: operations.DeletePolicyRequest) -> operations.DeletePolicyResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deletePolicy', oauth2_scopes=['auth:read','reconciliation:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_policy(self, request: operations.GetPolicyRequest) -> operations.GetPolicyResponse:
        r"""Get a policy"""
        hook_ctx = HookContext(operation_id='getPolicy', oauth2_scopes=['auth:read','reconciliation:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_reconciliation(self, request: operations.GetReconciliationRequest) -> operations.GetReconciliationResponse:
        ...
        hook_ctx = HookContext(operation_id='getReconciliation', oauth2_scopes=['auth:read','reconciliation:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_policies(self, request: operations.ListPoliciesRequest) -> operations.ListPoliciesResponse:
        r"""List policies"""
        hook_ctx = HookContext(operation_id='listPolicies', oauth2_scopes=['auth:read','reconciliation:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_reconciliations(self, request: operations.ListReconciliationsRequest) -> operations.ListReconciliationsResponse:
        ...
        hook_ctx = HookContext(operation_id='listReconciliations', oauth2_scopes=['auth:read','reconciliation:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def reconcile(self, request: operations.ReconcileRequest) -> operations.ReconcileResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='reconcile', oauth2_scopes=['auth:read','reconciliation:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def reconciliationget_server_info(self) -> operations.ReconciliationgetServerInfoResponse:
        r"""Get server info"""
        hook_ctx = HookContext(operation_id='reconciliationgetServerInfo', oauth2_scopes=['auth:read','reconciliation:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
