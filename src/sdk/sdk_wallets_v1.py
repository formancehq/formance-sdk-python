...
class SDKWalletsV1:
    ...
    def confirm_hold(self, request: operations.ConfirmHoldRequest) -> operations.ConfirmHoldResponse:
        r"""Confirm a hold"""
        hook_ctx = HookContext(operation_id='confirmHold', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/api/wallets/holds/{hold_id}/confirm', request)
    ...
    def create_balance(self, request: operations.CreateBalanceRequest) -> operations.CreateBalanceResponse:
        r"""Create a balance"""
        hook_ctx = HookContext(operation_id='createBalance', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/api/wallets/wallets/{id}/balances', request)
    ...
    def create_wallet(self, request: operations.CreateWalletRequest) -> operations.CreateWalletResponse:
        ...
        hook_ctx = HookContext(operation_id='createWallet', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        headers = { **utils.get_headers(request), **headers }
        req_content_type, data, form = utils.serialize_request_body(request, operations.CreateWalletRequest, "create_wallet_request", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
    ...
    def credit_wallet(self, request: operations.CreditWalletRequest) -> operations.CreditWalletResponse:
        r"""Credit a wallet"""
        hook_ctx = HookContext(operation_id='creditWallet', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def debit_wallet(self, request: operations.DebitWalletRequest) -> operations.DebitWalletResponse:
        r"""Debit a wallet"""
        hook_ctx = HookContext(operation_id='debitWallet', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_balance(self, request: operations.GetBalanceRequest) -> operations.GetBalanceResponse:
        ...
        hook_ctx = HookContext(operation_id='getBalance', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/api/wallets/wallets/{id}/balances/{balanceName}', request)
    ...
    def get_hold(self, request: operations.GetHoldRequest) -> operations.GetHoldResponse:
        r"""Get a hold"""
        hook_ctx = HookContext(operation_id='getHold', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_holds(self, request: operations.GetHoldsRequest) -> operations.GetHoldsResponse:
        ...
        hook_ctx = HookContext(operation_id='getHolds', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_transactions(self, request: operations.GetTransactionsRequest) -> operations.GetTransactionsResponse:
        hook_ctx = HookContext(operation_id='getTransactions', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_wallet(self, request: operations.GetWalletRequest) -> operations.GetWalletResponse:
        r"""Get a wallet"""
        hook_ctx = HookContext(operation_id='getWallet', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_wallet_summary(self, request: operations.GetWalletSummaryRequest) -> operations.GetWalletSummaryResponse:
        ...
        hook_ctx = HookContext(operation_id='getWalletSummary', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_balances(self, request: operations.ListBalancesRequest) -> operations.ListBalancesResponse:
        ...
        hook_ctx = HookContext(operation_id='listBalances', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def list_wallets(self, request: operations.ListWalletsRequest) -> operations.ListWalletsResponse:
        r"""List all wallets"""
        hook_ctx = HookContext(operation_id='listWallets', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def update_wallet(self, request: operations.UpdateWalletRequest) -> operations.UpdateWalletResponse:
        r"""Update a wallet"""
        hook_ctx = HookContext(operation_id='updateWallet', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def void_hold(self, request: operations.VoidHoldRequest) -> operations.VoidHoldResponse:
        r"""Cancel a hold"""
        hook_ctx = HookContext(operation_id='voidHold', oauth2_scopes=['auth:read','wallets:write'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/api/wallets/holds/{hold_id}/void', request)
    ...
    def walletsget_server_info(self) -> operations.WalletsgetServerInfoResponse:
        r"""Get server info"""
        hook_ctx = HookContext(operation_id='walletsgetServerInfo', oauth2_scopes=['auth:read','wallets:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
