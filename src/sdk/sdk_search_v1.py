...
class SDKSearchV1:
    ...
    def search(self, request: shared.Query) -> operations.SearchResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='search', oauth2_scopes=['search:write'], security_source=self.sdk_configuration.security)
    ...
    def searchget_server_info(self) -> operations.SearchgetServerInfoResponse:
        r"""Get server info"""
        hook_ctx = HookContext(operation_id='searchgetServerInfo', oauth2_scopes=['search:read'], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
