...
class PathValues(str, enum.Enum):
    ...
    API_WALLETS_WALLETS_ID_HOLDS = "/api/wallets/wallets/{id}/holds"
    API_WALLETS_WALLETS_ID_HOLDS_HOLD_ID_CONFIRM = "/api/wallets/wallets/{id}/holds/{hold_id}/confirm"
    API_WALLETS_WALLETS_ID_HOLDS_HOLD_ID_VOID = "/api/wallets/wallets/{id}/holds/{hold_id}/void"
