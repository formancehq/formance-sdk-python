...
class WebhooksCursor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["has_more", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["has_more", ], str]):
