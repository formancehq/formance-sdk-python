...
class ConfigDeactivated(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpoint", "secret", "eventTypes", "active", "createdAt", "modifiedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpoint", "secret", "eventTypes", "active", "createdAt", "modifiedAt", ], str]):
