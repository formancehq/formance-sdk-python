...
class Script(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["plain", "reference", "metadata", "vars", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plain", "reference", "metadata", "vars", ], str]):
