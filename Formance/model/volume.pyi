...
class Volume(
    ...
    class MetaOapg:
        ...
        class properties:
            input = schemas.NumberSchema
            output = schemas.NumberSchema
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        output: typing.Union[MetaOapg.properties.output, decimal.Decimal, int, float, ],
        input: typing.Union[MetaOapg.properties.input, decimal.Decimal, int, float, ],
