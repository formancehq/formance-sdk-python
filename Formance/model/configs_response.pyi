...
class ConfigsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def cursor() -> typing.Type['WebhooksCursor']:
                return WebhooksCursor
            __annotations__ = {
                "cursor": cursor,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cursor"]) -> 'WebhooksCursor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cursor"]) -> 'WebhooksCursor': ...
